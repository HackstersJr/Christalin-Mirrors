                        ...
                        {sent ? (
                            ...
                            <>
                                ...
                                <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', marginTop: '2rem' }}>
                                    <a href="tel:+919900118383" className="btn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', borderRadius: '50%', padding: 0, backgroundColor: 'rgba(0, 122, 255, 0.1)', color: '#007AFF', border: 'none', transition: 'all 0.3s ease' }} aria-label="Call Us">
                                        <Phone size={20} />
                                    </a>
                                    <a href="https://wa.me/919900118383" target="_blank" rel="noopener noreferrer" className="btn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', borderRadius: '50%', padding: 0, backgroundColor: 'rgba(37, 211, 102, 0.1)', color: '#25D366', border: 'none', transition: 'all 0.3s ease' }} aria-label="WhatsApp Us">
