                        ...
                        {sent ? (
                            ...
                            <>
                                ...
                                <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', marginTop: '2rem' }}>
                                    <a href="tel:+919900118383" className="btn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', borderRadius: '50%', padding: 0, backgroundColor: 'var(--accent-subtle)', color: 'var(--accent)', border: '1px solid var(--accent-muted)', transition: 'all 0.3s ease' }} aria-label="Call Us">
                                        <Phone size={20} />
                                    </a>
                                    <a href="https://wa.me/919900118383" target="_blank" rel="noopener noreferrer" className="btn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', borderRadius: '50%', padding: 0, backgroundColor: 'var(--accent-subtle)', color: 'var(--accent)', border: '1px solid var(--accent-muted)', transition: 'all 0.3s ease' }} aria-label="WhatsApp Us">
